...
const About = () => {
  return (
    <div className="h-screen w-screen flex flex-col justify-center items-center gap-8 py-10 text-white">
      <motion.h2 
        initial={{opacity: 0, y: -50}}
        animate={{opacity: 1, y: 0}}
        transition={{duration: 1}}
        className='text-center mt-8 text-shadow text-3xl sm:text-4xl font-semibold'
      >
        Un poco sobre mí
      </motion.h2>
      <div className="relative flex flex-col sm:flex-row justify-center gap-20">
        <motion.div 
